---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":5773,"closed":"1790341635","created":"1788791246","id":"SL-117","labels":["superseded"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1948,"stage":"backlog","status":"closed","title":"DF-146k — OPEN, needs a user decision (Aug 6). A borrows accessor cannot be declared SHARED-ONLY, so a container whose own invariants depend on an element cannot…","updated":"1790341635"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":125,"created":"1790341635","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): superseded by borrowing §3 (also §1, §9; §2.7 for forwarding).
