...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":164,"created":"1790341647","id":"c1"} -->
Sep 25 tracker cleanup: slices are settled by SL:borrowing §6, and computed properties are deferred (§10). Still open here: `\x` byte escapes and `where` clauses.
