---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2955,"closed":"1790341634","created":"1788791244","id":"SL-114","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1943,"stage":"backlog","status":"closed","title":"DF-169g — the automatic ImplicitCopy tier does not satisfy a Copy BOUND. Design 159 put a struct whose owning members are all trivial/ImplicitCopy on the…","updated":"1790341634"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":345,"created":"1790341634","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `copy-tier.bound`.
