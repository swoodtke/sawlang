---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":5045,"closed":"1790341652","created":"1788791276","id":"SL-182","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2048,"stage":"backlog","status":"closed","title":"Reconcile and measure the warehouse lowering performance plan","updated":"1790341652"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":269,"created":"1790341652","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `borrow.place-lowering`.
