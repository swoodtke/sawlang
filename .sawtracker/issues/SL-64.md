---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":7722,"closed":"1790341618","created":"1788791221","id":"SL-64","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1858,"stage":"backlog","status":"closed","title":"DF-261f: Diagnose recursively suspending functions without a raw traceback","updated":"1790341618"}
---
...
DF-261f: Diagnose recursively suspending functions without a raw traceback
...
- SL-63 — DF‑261e: Lower optional chains through Box fields without BindOptional ICEs
...
### sawlang TODO lines 111–111

[Original record](https://github.com/swoodtke/sawlang/blob/fd0b5aa8847e3edce9bdcd7880c9ed68923ca4c5/designs/todo.md#L111-L111)
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341618","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `coroutine.frame.recursion`.
