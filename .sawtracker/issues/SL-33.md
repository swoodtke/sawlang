---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3374,"closed":"1790341607","created":"1788791161","id":"SL-33","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1800,"stage":"backlog","status":"closed","title":"DF-251d: Define and lower suspending initializer calls safely","updated":"1790341607"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341607","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `coroutine.suspending-init`.
