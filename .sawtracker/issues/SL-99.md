---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3122,"closed":"1790341629","created":"1788791238","id":"SL-99","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1917,"stage":"backlog","status":"closed","title":"DF-204b — a closure's codegen symbol carries the LINE it was written on, so an unrelated edit above it renames the symbol. Adding a three-line comment to…","updated":"1790341629"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":271,"created":"1790341629","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `mangling.closure-symbol`.
