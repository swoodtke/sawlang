---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":5630,"closed":"1790341656","created":"1788791289","id":"SL-195","labels":["frozen","hazard","sawos-reported"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2071,"stage":"backlog","status":"closed","title":"Give module-level statics defining-module identity","updated":"1790341656"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":352,"created":"1790341656","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `static.module-identity`.
