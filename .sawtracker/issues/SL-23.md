---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4235,"closed":"1790341603","created":"1788791157","id":"SL-23","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1781,"stage":"backlog","status":"closed","title":"DF-242a: Release driven try-body locals at the error edge","updated":"1790341603"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":269,"created":"1790341603","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `drop.try-catch.driven`.
