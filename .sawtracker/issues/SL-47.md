---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":8743,"closed":"1790341613","created":"1788791214","id":"SL-47","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1829,"stage":"backlog","status":"closed","title":"DF-267c: Allow indexed lends through match-bound payload places","updated":"1790341613"}
---
...
DF-267c: Allow indexed lends through match-bound payload places
...
### sawlang TODO lines 93–93

[Original record](https://github.com/swoodtke/sawlang/blob/fd0b5aa8847e3edce9bdcd7880c9ed68923ca4c5/designs/todo.md#L93-L93)
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341613","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `borrow.lend.payload-index`.
