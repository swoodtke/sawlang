---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4015,"closed":"1790341653","created":"1788791277","id":"SL-184","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2052,"stage":"backlog","status":"closed","title":"Verify nested generics whose templates suspend unconditionally","updated":"1790341653"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":272,"created":"1790341653","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `coroutine.generic-nested`.
