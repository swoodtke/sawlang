---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2835,"closed":"1790341628","created":"1788791236","id":"SL-96","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1912,"stage":"backlog","status":"closed","title":"DF-212c (RECORDED, pre-existing, found while fixing DF-212b) — a generic EXTENSION whose type parameter is spelled like a module type name loses every method.","updated":"1790341628"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":356,"created":"1790341628","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `generic.param-shadows-type`.
