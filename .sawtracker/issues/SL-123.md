---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2658,"closed":"1790341636","created":"1788791249","id":"SL-123","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1956,"stage":"backlog","status":"closed","title":"DF-168a — _CatchError_{node_id} is the last node-id-derived name in the compiler. typechecker/expressions.py:9077, the union enum a multi-type try/catch…","updated":"1790341636"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":269,"created":"1790341636","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `try-catch.error-union`.
