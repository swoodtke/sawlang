---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6676,"closed":"1790341619","created":"1788791223","id":"SL-67","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1864,"stage":"backlog","status":"closed","title":"DF-272c: Make std and user checks agree on maybe-suspending place windows","updated":"1790341619"}
---
...
DF-272c: Make std and user checks agree on maybe-suspending place windows
...
### sawlang TODO lines 114–114

[Original record](https://github.com/swoodtke/sawlang/blob/fd0b5aa8847e3edce9bdcd7880c9ed68923ca4c5/designs/todo.md#L114-L114)
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":272,"created":"1790341619","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `borrow.window.suspension`.
