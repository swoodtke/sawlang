---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2580,"closed":"1790341615","created":"1788791217","id":"SL-54","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1842,"stage":"backlog","status":"closed","title":"DF-271a: Reconcile std pre-check try propagation in nested generic bodies","updated":"1790341615"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":264,"created":"1790341615","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `try.generic-body`.
