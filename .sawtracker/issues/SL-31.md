---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3403,"closed":"1790341606","created":"1788791160","id":"SL-31","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1796,"stage":"backlog","status":"closed","title":"DF-251b: Register owning parameter cleanup in generic initializers","updated":"1790341606"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":353,"created":"1790341606","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `drop.generic-init-param`.
