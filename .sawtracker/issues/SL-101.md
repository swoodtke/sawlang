---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2412,"closed":"1790341630","created":"1788791239","id":"SL-101","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1921,"stage":"backlog","status":"closed","title":"DF-210d: Audit the unused ForceUnwrap.frame_move_read marker","updated":"1790341630"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":276,"created":"1790341630","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `coroutine.frame.force-unwrap`.
