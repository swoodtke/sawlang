---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4410,"closed":"1790341625","created":"1788791232","id":"SL-86","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1896,"stage":"backlog","status":"closed","title":"DF-218b (BOGUS-REFUSAL, found probing DF-218a, pre-existing and unrelated to its fix). <place>.take() on an optional-typed place is refused, and the diagnostic…","updated":"1790341625"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":266,"created":"1790341625","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `borrow.window.mode`.
