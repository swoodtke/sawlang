---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6776,"closed":"1790341619","created":"1788791223","id":"SL-68","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":5,"sequence":2409,"stage":"backlog","status":"closed","title":"DF-276a: Diagnose unrepresentable float literals instead of producing infinity or zero","updated":"1790344904"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":330,"created":"1790341619","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `literal.float.range`. Its test-plan input is carried in SL-393 (the rule inventory).
