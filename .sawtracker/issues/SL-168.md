---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2536,"closed":"1790341648","created":"1788791269","id":"SL-168","labels":["done"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2026,"stage":"backlog","status":"closed","title":"DF-112b (pin deviation, design 112): the pinned ISA was rv32imac_zicsr, but llvmlite emits rv32i (base, ilp32 soft-float) for the riscv32-unknown-none-elf triple…","updated":"1790341648"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":100,"created":"1790341648","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): already done: `--target-features` exists.
