---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":7710,"closed":"1790341617","created":"1788791220","id":"SL-61","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1852,"stage":"backlog","status":"closed","title":"DF-261c: Honor handwritten Equatable.equals for enums","updated":"1790341617"}
---
...
DF-261c: Honor handwritten Equatable.equals for enums
...
### sawlang TODO lines 108–108

[Original record](https://github.com/swoodtke/sawlang/blob/fd0b5aa8847e3edce9bdcd7880c9ed68923ca4c5/designs/todo.md#L108-L108)
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":356,"created":"1790341617","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `equatable.enum-user-equals`.
