---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2041,"closed":"1790341628","created":"1788791236","id":"SL-94","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1909,"stage":"backlog","status":"closed","title":"DF-215b — move of a frame local in a nested block's TAIL expression is refused in a suspending body. 25-line repro, ready to become a cited pin; the diagnostic's…","updated":"1790341628"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341628","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `move.block-tail.coroutine`.
