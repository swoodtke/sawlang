---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2762,"closed":"1790341633","created":"1788791243","id":"SL-112","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1939,"stage":"backlog","status":"closed","title":"DF-175c — OPEN (minor, docs). --emit-docs cannot distinguish a &var self borrows accessor from a plain &var self method — the former reports \"self\":…","updated":"1790341633"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":271,"created":"1790341633","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `docs.emit.receiver-kind`.
