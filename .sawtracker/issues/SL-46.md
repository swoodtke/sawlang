---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":8767,"closed":"1790341612","created":"1788791167","id":"SL-46","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1827,"stage":"backlog","status":"closed","title":"DF-267a: Resolve Optional methods on optional-typed borrows places","updated":"1790341612"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":369,"created":"1790341612","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `borrow.conditional-lend.optional-method`.
