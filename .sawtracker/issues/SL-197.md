---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6417,"closed":"1790341656","created":"1788791291","id":"SL-197","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":2074,"stage":"backlog","status":"closed","title":"DF-218s remainder: pattern bindings and value-block release timing","updated":"1790341656"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":268,"created":"1790341656","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `drop.order.coroutine`.
