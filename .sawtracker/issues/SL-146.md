---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3862,"closed":"1790341642","created":"1788791259","id":"SL-146","labels":["superseded"],"order":0,"parent":"","priority":"low","project":"SL","queue_order":0,"revision":3,"sequence":1993,"stage":"backlog","status":"closed","title":"Reconcile the deferred io_wait intrinsic gate","updated":"1790341642"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":208,"created":"1790341642","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): superseded by LANGUAGE_SPEC (`io_wait` is private) and SL:testing §4: test sidecars give the reactor's white-box tests private access (user ruling).
