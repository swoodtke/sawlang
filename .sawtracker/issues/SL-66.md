---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6696,"closed":"1790341618","created":"1788791222","id":"SL-66","labels":["superseded"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1862,"stage":"backlog","status":"closed","title":"DF-272b: Rule default type arguments for bare generic type names","updated":"1790341618"}
---
...
- SL-65 — DF‑272a: Infer closure arguments from enum-variant payload types
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":126,"created":"1790341618","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): superseded by architecture §3.0 (types are interned by structure).
