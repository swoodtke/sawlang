---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3491,"closed":"1790341612","created":"1788791166","id":"SL-44","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1823,"stage":"backlog","status":"closed","title":"DF-264a: Validate Copy deinit signatures consistently with the other tiers","updated":"1790341612"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":274,"created":"1790341612","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `copy-tier.deinit-signature`.
