---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2900,"closed":"1790341612","created":"1788791166","id":"SL-45","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1825,"stage":"backlog","status":"closed","title":"DF-266a: Parse a negative tail after if-return without a BinaryOp crash","updated":"1790341612"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":411,"created":"1790341612","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `parse.newline.leading-minus`. Its ruling is carried in SL-393 (the rule inventory).
