---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":5253,"closed":"1790349803","created":"1788791225","id":"SL-72","labels":["superseded"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":2500,"stage":"backlog","status":"closed","title":"DF-283c: Rule typed unsigned operands in constant-expression evaluation","updated":"1790349803"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":436,"created":"1790349803","id":"c1","kind":"landing"} -->
Closed: settled by the user's constexpr ruling (Sep 25; SL:architecture §3.10 r39). Constant arithmetic is ordinary typed arithmetic, evaluated by the MIR interpreter on the same MIR as run time: literals adopt their types, then typed operations apply. Design 185's signed platform-Int fold domain retires, so unsigned operands behave in constants exactly as at run time. Today's refusals of that kind are annotated 'language changed'.
