---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4301,"closed":"1790341600","created":"1788791152","id":"SL-13","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1764,"stage":"backlog","status":"closed","title":"DF-242c: Disambiguate integer overloads using exact-typed literals","updated":"1790341600"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":366,"created":"1790341600","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `overload.resolution.suffixed-literal`.
