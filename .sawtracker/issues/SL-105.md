---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3745,"closed":"1790341631","created":"1788791240","id":"SL-105","labels":["superseded"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1929,"stage":"backlog","status":"closed","title":"DF-200a (over-rejection, filed Aug 10 by design 200 unit 1's rows): the &var self.<field> PROJECTION rule reads the lvalue SYNTACTICALLY, so it refuses a…","updated":"1790341631"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":295,"created":"1790341631","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): superseded by SL:borrowing §9 (user ruling, SL:tracker-cleanup t2): design 200's carve-out is retired, so conformance rows M28 and M32 become refusals, annotated "language changed". Its ruling is carried in SL-393 (the rule inventory).
