---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3194,"closed":"1790341641","created":"1788791256","id":"SL-139","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1984,"stage":"backlog","status":"closed","title":"DF-126a: Verify the latent pre-port AST annotation contract","updated":"1790341641"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":270,"created":"1790341641","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `mono.type-substitution`.
