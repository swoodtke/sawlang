---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2355,"closed":"1790341626","created":"1788791233","id":"SL-88","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1900,"stage":"backlog","status":"closed","title":"DF-218d (ICE, sawfuzz-oracle class) — a value-if statement followed by a line beginning with - dies internal compiler error (BinaryOp): 'NoneType' object has no…","updated":"1790341626"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":356,"created":"1790341626","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `syntax.newline.unary-minus`.
