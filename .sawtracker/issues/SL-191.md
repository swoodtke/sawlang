---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4486,"closed":"1790341654","created":"1788791287","id":"SL-191","labels":["frozen","hazard","sawos-reported"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2063,"stage":"backlog","status":"closed","title":"Allow element writes through a directly borrowed mutable fixed array","updated":"1790341654"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":359,"created":"1790341654","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `reference.array-element-write`.
