---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6081,"closed":"1790341621","created":"1788791226","id":"SL-74","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1876,"stage":"backlog","status":"closed","title":"DF-287a: Keep fall-through ownership after a move in a diverging catch","updated":"1790341621"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":350,"created":"1790341621","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `move.diverging-catch`.
