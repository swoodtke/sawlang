---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":6358,"closed":"1790341616","created":"1788791219","id":"SL-59","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1849,"stage":"backlog","status":"closed","title":"DF-215j: Implement the ruled statement-arm grammar for return in match arms","updated":"1790341616"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":403,"created":"1790341616","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `match.statement-arm`. Its ruling is carried in SL-393 (the rule inventory).
