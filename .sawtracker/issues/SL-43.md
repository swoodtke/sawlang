---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2229,"closed":"1790341611","created":"1788791165","id":"SL-43","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1821,"stage":"backlog","status":"closed","title":"DF-262b: Fix the suspend-interpolation, task-result and optional-wrap LLVM mismatch","updated":"1790341611"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":270,"created":"1790341611","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `coroutine.anf.autowrap`.
