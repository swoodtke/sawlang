---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":1943,"closed":"","created":"1788791268","id":"SL-166","labels":["language"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2023,"stage":"backlog","status":"open","title":"S5 small-string optimization — ABI-gated (\"before separate compilation or never\"). [07]","updated":"1790341647"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":194,"created":"1790341647","id":"c1"} -->
Kept as `language` in the Sep 25 tracker cleanup (user ruling). Decide it before `String`'s layout is fixed in the new std, since shipped package interfaces fix layouts (SL:architecture §3.12).
