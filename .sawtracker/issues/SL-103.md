---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4503,"closed":"1790341631","created":"1788791239","id":"SL-103","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1925,"stage":"backlog","status":"closed","title":"DF-206d: Audit name versus node-identity keying at the std effect seam","updated":"1790341631"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":272,"created":"1790341631","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `effect.suspend-inference`.
