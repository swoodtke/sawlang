---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":4750,"closed":"1790341601","created":"1788791153","id":"SL-15","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1768,"stage":"backlog","status":"closed","title":"DF-225o: Reproduce compiler reemit divergence under load","updated":"1790341601"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":274,"created":"1790341601","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `determinism.emission-order`.
