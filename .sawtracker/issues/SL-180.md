---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":22970,"closed":"1790341651","created":"1788791275","id":"SL-180","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":2045,"stage":"backlog","status":"closed","title":"Audit residual findings from the ownership and labeled-call sweeps","updated":"1790341651"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":270,"created":"1790341651","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `copy-tier.generic-body`.
