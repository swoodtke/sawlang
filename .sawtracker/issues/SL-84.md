---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2959,"closed":"","created":"1788791231","id":"SL-84","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":2,"sequence":1890,"stage":"backlog","status":"open","title":"DF-178e — a bare literal does not adopt an annotated type through a match. let ra: UInt = match a.join() { case Ok(v) -> v, case Err(_) -> 0 } is the match arms…","updated":"1790341623"}
---
