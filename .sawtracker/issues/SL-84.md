---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2959,"closed":"1790341624","created":"1788791231","id":"SL-84","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1891,"stage":"backlog","status":"closed","title":"DF-178e — a bare literal does not adopt an annotated type through a match. let ra: UInt = match a.join() { case Ok(v) -> v, case Err(_) -> 0 } is the match arms…","updated":"1790341624"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":356,"created":"1790341624","id":"c1","kind":"landing"} -->
