---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3922,"closed":"1790341609","created":"1788791164","id":"SL-40","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1811,"stage":"backlog","status":"closed","title":"DF-259b: Explain reserved words at every declaration-name position","updated":"1790341609"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341609","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `diagnostics.reserved-word`.
