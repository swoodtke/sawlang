---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":7046,"closed":"1790341655","created":"1788791287","id":"SL-192","labels":["frozen","hazard","sawos-reported","memory-safety"],"order":0,"parent":"","priority":"high","project":"SL","queue_order":0,"revision":3,"sequence":2065,"stage":"backlog","status":"closed","title":"Enforce borrowed place-match ownership, including nested read-only matches","updated":"1790341655"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":354,"created":"1790341655","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `match.place-payload-move`.
