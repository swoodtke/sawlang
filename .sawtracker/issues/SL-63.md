---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":7627,"closed":"1790341618","created":"1788791221","id":"SL-63","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1856,"stage":"backlog","status":"closed","title":"DF-261e: Lower optional chains through Box fields without BindOptional ICEs","updated":"1790341618"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":354,"created":"1790341618","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `optional.chain.box-field`.
