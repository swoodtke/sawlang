---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3915,"closed":"1790341657","created":"1788791291","id":"SL-198","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":2076,"stage":"backlog","status":"closed","title":"DF-257c remainder: carry per-instantiation try annotations","updated":"1790341657"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341657","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `try.generic-instantiation`.
