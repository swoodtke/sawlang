---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3810,"closed":"1790341639","created":"1788791252","id":"SL-131","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1972,"stage":"backlog","status":"closed","title":"DF-151k — FILED, NOT FIXED (typechecker; found while fixing DF-151i, Aug 7). type_satisfies_copy_bound has no OPTIONAL and no TUPLE arm, so a fixed array of…","updated":"1790341639"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":360,"created":"1790341639","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `copy-tier.bound.optional-tuple`.
