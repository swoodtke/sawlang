---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":7655,"closed":"1790341617","created":"1788791221","id":"SL-62","labels":["frozen","hazard"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":4,"sequence":1854,"stage":"backlog","status":"closed","title":"DF-261d: Forward Box payload methods to enum payloads","updated":"1790341617"}
---
...
DF-261d: Forward Box payload methods to enum payloads
...
### sawlang TODO lines 109–109

[Original record](https://github.com/swoodtke/sawlang/blob/fd0b5aa8847e3edce9bdcd7880c9ed68923ca4c5/designs/todo.md#L109-L109)
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":351,"created":"1790341617","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Its shape is carried into SL:hazards, so the new compiler's own source avoids it. Test-coverage aspect: `box.method-forwarding`.
