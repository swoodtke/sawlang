---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":3933,"closed":"1790341606","created":"1788791159","id":"SL-29","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1792,"stage":"backlog","status":"closed","title":"DF-250b: Refuse an invalid None coalescing default without an LLVM crash","updated":"1790341606"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":278,"created":"1790341606","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `optional.coalesce.none-default`.
