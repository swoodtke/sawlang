---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":2519,"closed":"1790341640","created":"1788791253","id":"SL-134","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1978,"stage":"backlog","status":"closed","title":"Measure reusable Printable formatting scratch storage","updated":"1790341640"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":277,"created":"1790341640","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `format-args.printable-scratch`.
