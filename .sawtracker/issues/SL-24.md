---
{"acceptance":[],"assignee":"","author":"agent:codex-todo-import","body_bytes":5140,"closed":"1790341604","created":"1788791157","id":"SL-24","labels":["frozen"],"order":0,"parent":"","priority":"normal","project":"SL","queue_order":0,"revision":3,"sequence":1783,"stage":"backlog","status":"closed","title":"DF-218w: Align mixed-pattern payload release timing between sync and driven code","updated":"1790341604"}
---
...
<!-- sawtracker:comment {"author":"agent:claude-sawlang","body_bytes":273,"created":"1790341604","id":"c1","kind":"landing"} -->
Closed in the Sep 25 tracker cleanup (SL:tracker-cleanup): a defect in the Python compiler, which is frozen (Sep 24). The frozen compiler stays the differential oracle, and this issue is its "oracle known wrong" reference. Test-coverage aspect: `drop.match-payload.driven`.
